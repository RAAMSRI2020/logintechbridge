...
const Service = () => (
    <section id='service' className='w-full overflow-hidden flex  flex-1'>
        <div className='w-full overflow-hidden flex flex-1  flex-col '>
            ...
            <div className="sm:mx-6  md:mx-20 m-0 flex sm:flex-row flex-col md:space-x-16 sm:space-x-4 space-x-0 justify-center">
                {ServiceList.map((service,index)=>(
                <div  key={service.id} className="sm:h-[80vh] h-[100vh] sm:w-[40vw] md:w-[20vw] w-screen border-2 border-blue-100 rounded-sm shadow bg-dimWhite">
                    <div className="h-[25%] ">
                    ...
                    <div className="">
                        ...
                        <div className="flex items-center justify-center p-4 flex-col">
                            ...
                            <p className="font-poppins leading-loose p-4 px-3 sm:w-[80%] w-full h-full text-justify">
                                {service.description}
                            </p>
                        </div>
