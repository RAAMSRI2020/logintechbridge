...
const Testimonial = () =>(
    <section id='testimonial' className='w-full h-full flex flex-col'>
      <div className='sm:w-[100vw] w-screen flex flex-col  p-12 border-2 shadow space-y-2 relative z-10 bg-dimWhite items-center justify-center text-center'>
      ...
      <div className="w-auto flex sm:flex-row flex-col items-start  justify-center relative shadow ">
        ...
        prevArrow={({ handlePrev }) => (
          <IconButton
            ...
            size="lg"
            onClick={handlePrev}
            className="!absolute top-2/4 left-4 -translate-y-1/4"
          >
            <svg
        ...
        nextArrow={({ handleNext }) => (
          <IconButton
            ...
            size="lg"
            onClick={handleNext}
            className="!absolute top-2/4 !right-4 -translate-y-1/4"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
